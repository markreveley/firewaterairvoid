...
export function ItemList({ items, type, selectedTagFilter }: ItemListProps) {
    ...
    <div className="space-y-3">
      {filteredItems.length === 0 ? (
        <div className="text-center py-12 text-muted-foreground">
          <p>No items yet. Start by adding one above!</p>
        </div>
      ) : (
                  ...
                  {item.tags.map((tag) => (
                    <Badge
                      ...
                      className={cn(
                        "text-xs",
                        tag.type === "fire"
                          ? "border-fire-secondary text-fire-dark"
                          : "border-water-secondary text-water-dark"
                      )}
                    >
                      {tag.type === "fire" ? (
